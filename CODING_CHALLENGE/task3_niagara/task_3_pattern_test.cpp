...
int main(int argc, char *argv[])
{
    ...
    alltoallv_helper::randomPatternGenerator(pattern1, 2000, 1, 5000, p_target, 5114);
    alltoallv_helper::randomPatternGenerator(pattern2, 2000, 1, 5000, p_target, 3417);
    alltoallv_helper::randomPatternGenerator(pattern3, 2000, 1, 5000, p_target, 4598);
    alltoallv_helper::randomPatternGenerator(pattern4, 2000, 1, 5000, p_target, 904);
    

    int x[10] = {230, 150, 200, 2005, 1400, 600, 1100, 10, 2400, 400};
    // generate modulus patterns
    alltoallv_helper::modulusPatternGenerator(pattern5, 1, 13, &x[0], 10, p_target);
    alltoallv_helper::modulusPatternGenerator(pattern6, 1, 5, &x[0], 7, p_target);
